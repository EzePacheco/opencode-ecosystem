...
description: Use when Codex builder changes or local diffs need a critical code review focused on bugs, regressions, security, contracts, and missing verification.
---
