...
Indice operativo para cargar standards on-demand en Codex. Leer este archivo
...
| `ai-workflow-standards.md` | Uso de Codex, agents, skills, MCP, contexto, verificacion, handoffs o guardrails | Main thread orquesta; skills y standards se cargan on-demand; subagentes solo cuando aportan aislamiento, paralelismo o review fresca. |
